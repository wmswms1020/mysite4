	...
	<div id="wrap">
		...
		<div id="container" class="clearfix">
			...
			<div id="content">
				...
				<div id="user">
					<div id="joinForm">
						<form action="/mysite4/join" method="get">
							...
							<div class="form-group">
								...
								<input type="radio" id="rdo-male" name="gender" value="male"> <label for="rdo-female">여</label> <input type="radio" id="rdo-female" name="gender" value="frmale">
		...
		<div id="footer">Copyright ⓒ 2022 소준호. All right reserved</div>
		<!-- //footer -->
